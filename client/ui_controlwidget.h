...
public:
    ...
    void setupUi(QWidget *ControlWidget)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/image/control_01.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/image/control_02.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/image/control_03.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/image/control_04.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        mosaicBtn->setObjectName(QString::fromUtf8("mosaicBtn"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/image/control_05.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8("image/control_06.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/image/control_07.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/image/control_08.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/image/control_09.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/image/control_10.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/image/control_11.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/image/control_12.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/image/control_13.jpg"), QSize(), QIcon::Normal, QIcon::Off);
